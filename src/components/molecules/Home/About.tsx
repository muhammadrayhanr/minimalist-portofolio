      ...
      <div className='space-y-8'>
        ...
        <AnimatePresence>
          {showList && (
            ...
            >
              <ul className='list-disc space-y-4 ml-8 dot'>
                <li>
                ...
                <li>
                  ...
                  to different projects. If you have a project that needs an extra
                  set of hands or fresh ideas, feel free to reach out to me!
                </li>
                <li>
