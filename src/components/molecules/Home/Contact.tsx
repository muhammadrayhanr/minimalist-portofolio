  ...
  return (
    <SpotlightCard>
      <div className='flex flex-col justify-center items-center w-full'>
        ...
        <Link href={'/contact'} className='text-sm mt-6 px-4 py-2 mb-7 sm:mb-0 rounded-full bg-white text-black border border-white hover:bg-transparent hover:text-white transition-all duration-600'>Contact Me</Link>
